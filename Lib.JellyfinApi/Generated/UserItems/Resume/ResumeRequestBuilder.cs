...
using System;
namespace JellyfinPlayer.Lib.Api.UserItems.Resume
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder.ResumeRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder.ResumeRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder.ResumeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder.ResumeRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.UserItems.Resume.ResumeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets items based on a query.
        /// </summary>
