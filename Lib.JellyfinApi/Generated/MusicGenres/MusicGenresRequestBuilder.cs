...
using JellyfinPlayer.Lib.Api.MusicGenres.InstantMix;
using JellyfinPlayer.Lib.Api.MusicGenres.Item;
...
using System;
namespace JellyfinPlayer.Lib.Api.MusicGenres
{
    /// <summary>
    ...
    public partial class MusicGenresRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::JellyfinPlayer.Lib.Api.MusicGenres.InstantMix.InstantMixRequestBuilder InstantMix
        {
            get => new global::JellyfinPlayer.Lib.Api.MusicGenres.InstantMix.InstantMixRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the JellyfinPlayer.Lib.Api.MusicGenres.item collection</summary>
        /// <param name="position">The genre name.</param>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.MusicGenres.Item.GenreNameItemRequestBuilder"/></returns>
        public global::JellyfinPlayer.Lib.Api.MusicGenres.Item.GenreNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("genreName%2Did", position);
                return new global::JellyfinPlayer.Lib.Api.MusicGenres.Item.GenreNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder.MusicGenresRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder.MusicGenresRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder.MusicGenresRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder.MusicGenresRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.MusicGenres.MusicGenresRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all music genres from a given item, folder, or the entire library.
        /// </summary>
