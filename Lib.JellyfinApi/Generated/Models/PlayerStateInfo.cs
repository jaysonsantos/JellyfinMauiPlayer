...
#nullable restore
        ...
        public global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlaybackOrder? PlaybackOrder { get; set; }
        /// <summary>Gets or sets the play method.</summary>
        public global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlayMethod? PlayMethod { get; set; }
        /// <summary>Gets or sets the now playing position ticks.</summary>
        public long? PositionTicks { get; set; }
        /// <summary>Gets or sets the repeat mode.</summary>
        public global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_RepeatMode? RepeatMode { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "PlayMethod", n => { PlayMethod = n.GetEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlayMethod>(); } },
                { "PlaybackOrder", n => { PlaybackOrder = n.GetEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlaybackOrder>(); } },
                { "PositionTicks", n => { PositionTicks = n.GetLongValue(); } },
                { "RepeatMode", n => { RepeatMode = n.GetEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_RepeatMode>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlaybackOrder>("PlaybackOrder", PlaybackOrder);
            writer.WriteEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_PlayMethod>("PlayMethod", PlayMethod);
            writer.WriteLongValue("PositionTicks", PositionTicks);
            writer.WriteEnumValue<global::JellyfinPlayer.Lib.Api.Models.PlayerStateInfo_RepeatMode>("RepeatMode", RepeatMode);
