...
namespace JellyfinPlayer.Lib.Api.Models
{
    ...
    public partial class StartupRemoteAccessDto : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Models.StartupRemoteAccessDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::JellyfinPlayer.Lib.Api.Models.StartupRemoteAccessDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::JellyfinPlayer.Lib.Api.Models.StartupRemoteAccessDto();
        }
        /// <summary>
