...
#nullable restore
        ...
        public global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_HardwareAccelerationType? HardwareAccelerationType { get; set; }
        ...
        public global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_TranscodeReasons? TranscodeReasons { get; set; }
        /// <summary>Gets or sets the thread count used for encoding.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "HardwareAccelerationType", n => { HardwareAccelerationType = n.GetEnumValue<global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_HardwareAccelerationType>(); } },
                { "Height", n => { Height = n.GetIntValue(); } },
                { "IsAudioDirect", n => { IsAudioDirect = n.GetBoolValue(); } },
                { "IsVideoDirect", n => { IsVideoDirect = n.GetBoolValue(); } },
                { "TranscodeReasons", n => { TranscodeReasons = n.GetEnumValue<global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_TranscodeReasons>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_HardwareAccelerationType>("HardwareAccelerationType", HardwareAccelerationType);
            writer.WriteIntValue("Height", Height);
            writer.WriteBoolValue("IsAudioDirect", IsAudioDirect);
            writer.WriteBoolValue("IsVideoDirect", IsVideoDirect);
            writer.WriteEnumValue<global::JellyfinPlayer.Lib.Api.Models.TranscodingInfo_TranscodeReasons>("TranscodeReasons", TranscodeReasons);
