...
using System;
namespace JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder.RecommendedRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder.RecommendedRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder.RecommendedRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder.RecommendedRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.LiveTv.Programs.Recommended.RecommendedRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets recommended live tv epgs.
        /// </summary>
