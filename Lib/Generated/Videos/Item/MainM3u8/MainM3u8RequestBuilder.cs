...
using System;
namespace JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder.MainM3u8RequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.MainM3u8RequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a video stream using HTTP live streaming.
        /// </summary>
...
#nullable restore
            ...
            public global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            public global::JellyfinPlayer.Lib.Api.Videos.Item.MainM3u8.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
