...
using JellyfinPlayer.Lib.Api.Studios.Item;
...
using System;
namespace JellyfinPlayer.Lib.Api.Studios
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the JellyfinPlayer.Lib.Api.Studios.item collection</summary>
        /// <param name="position">Studio name.</param>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Studios.Item.WithNameItemRequestBuilder"/></returns>
        public global::JellyfinPlayer.Lib.Api.Studios.Item.WithNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("name", position);
                return new global::JellyfinPlayer.Lib.Api.Studios.Item.WithNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder.StudiosRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder.StudiosRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder.StudiosRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder.StudiosRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.Studios.StudiosRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all studios from a given item, folder, or the entire library.
        /// </summary>
