...
using System;
namespace JellyfinPlayer.Lib.Api.Items.Filters2
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.QueryFilters?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder.Filters2RequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.QueryFilters> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder.Filters2RequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::JellyfinPlayer.Lib.Api.Models.QueryFilters>(requestInfo, global::JellyfinPlayer.Lib.Api.Models.QueryFilters.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets query filters.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder.Filters2RequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder.Filters2RequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.Items.Filters2.Filters2RequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets query filters.
        /// </summary>
