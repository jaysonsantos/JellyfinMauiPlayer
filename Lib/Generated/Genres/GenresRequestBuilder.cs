...
using JellyfinPlayer.Lib.Api.Genres.Item;
...
using System;
namespace JellyfinPlayer.Lib.Api.Genres
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the JellyfinPlayer.Lib.Api.Genres.item collection</summary>
        /// <param name="position">The genre name.</param>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Genres.Item.GenreNameItemRequestBuilder"/></returns>
        public global::JellyfinPlayer.Lib.Api.Genres.Item.GenreNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("genreName%2Did", position);
                return new global::JellyfinPlayer.Lib.Api.Genres.Item.GenreNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.Genres.GenresRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all genres from a given item, folder, or the entire library.
        /// </summary>
