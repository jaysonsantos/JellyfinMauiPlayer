...
using JellyfinPlayer.Lib.Api.LiveTv.Channels.Item;
...
using System;
namespace JellyfinPlayer.Lib.Api.LiveTv.Channels
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the JellyfinPlayer.Lib.Api.LiveTv.Channels.item collection</summary>
        /// <param name="position">Channel id.</param>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Channels.Item.WithChannelItemRequestBuilder"/></returns>
        public global::JellyfinPlayer.Lib.Api.LiveTv.Channels.Item.WithChannelItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("channelId", position);
                return new global::JellyfinPlayer.Lib.Api.LiveTv.Channels.Item.WithChannelItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder.ChannelsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder.ChannelsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder.ChannelsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder.ChannelsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets available live tv channels.
        /// </summary>
...
#nullable restore
            ...
            public global::JellyfinPlayer.Lib.Api.LiveTv.Channels.SortOrder? SortOrder { get; set; }
            ...
            [QueryParameter("type")]
            public global::JellyfinPlayer.Lib.Api.LiveTv.Channels.ChannelType? Type { get; set; }
