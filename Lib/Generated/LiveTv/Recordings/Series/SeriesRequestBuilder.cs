...
using System;
namespace JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::JellyfinPlayer.Lib.Api.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.SeriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets live tv recording series.
        /// </summary>
...
#nullable restore
            ...
            public global::JellyfinPlayer.Lib.Api.LiveTv.Recordings.Series.RecordingStatus? Status { get; set; }
